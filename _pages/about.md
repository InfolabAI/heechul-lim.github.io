...
3. **TENAS: Using Taylor Expansion and Channel-level Skip Connection for Neural Architecture Search**  
...
### LG Electronics, Industry Scholarship Recipient (PhD)  
**(Mar. 2023 – Aug. 2023, Seoul, Korea)**
...
- **Programming & Frameworks**: Python, PyTorch, ONNX, TensorFlow  
- **Machine Learning**: Anomaly Detection, GANs, Weakly Supervised Learning, Graph Neural Networks  
- **Computer Vision**: VLP, Prompt Learning, Distribution Shift, AutoML (NAS)  
- **NLP**: BERT, Knowledge Base Population, Entity Linking  
- **Software Development**: CI/CD, Docker, Git, Agile methodologies
...
**If you have any questions or would like to discuss potential collaborations, please do not hesitate to contact me!**
